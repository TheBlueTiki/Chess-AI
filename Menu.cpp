...
Menu::Menu()
{
	...
	//set boarders
	m_startButtonBoarder.setSize(Vector2f(m_startButton.getGlobalBounds().width, m_startButton.getGlobalBounds().height));
	m_startButtonBoarder.setFillColor(Color(0, 0, 0, 0));
	m_startButtonBoarder.setOutlineColor(Color(255, 255, 255));
	m_startButtonBoarder.setOutlineThickness(2);
	m_newGameButtonBoarder = m_startButtonBoarder;
	m_quitButtonBoarder = m_startButtonBoarder;
...
void Menu::OpenStartMenu(RenderWindow& a_win)
{
	...
	m_startButtonBoarder.setPosition(112 * m_scale, 112 * m_scale + 28 * m_scale);
	m_quitButtonBoarder.setPosition(112 * m_scale, 112 * m_scale + 140 * m_scale);
	
	//draw menu elements
	a_win.draw(m_fade);
	DrawStartButton(a_win);
	DrawQuitButton(a_win);
	a_win.draw(m_startButtonBoarder);
	a_win.draw(m_quitButtonBoarder);
}
/*void Menu::OpenStartMenu(RenderWindow& a_win)*/
...
void Menu::OpenPauseMenu(RenderWindow& a_win)
{
	...
	//position the boarders
	m_newGameButtonBoarder.setPosition(112 * m_scale, 112 * m_scale + 28 * m_scale);
	m_quitButtonBoarder.setPosition(112 * m_scale, 112 * m_scale + 140 * m_scale);
	...
	DrawQuitButton(a_win);
	a_win.draw(m_newGameButtonBoarder);
	a_win.draw(m_quitButtonBoarder);
}
/*void Menu::OpenPauseMenu(RenderWindow& a_win)*/
